    ...
    return (
        <div className="mb-12">
            ...
            <p className="text-neutral-400 leading-relaxed mb-6">
                Two light-blue ovals on black, no mouth: people read eyes far more
                strongly, so every emotion is forced through geometry and timing. The
                panel below runs the robot's own renderer on a canvas instead of
                pygame, with the same easing curves and keyframe values. Pick a pose
                and watch it blend.
            </p>
            ...
            <p className="text-sm text-neutral-500 leading-relaxed mt-4">
                Timing is part of the pose: startle snaps in elastically in
                0.12&nbsp;s, melancholy seeps in over 0.55&nbsp;s.
            </p>
        </div>
    );
};
